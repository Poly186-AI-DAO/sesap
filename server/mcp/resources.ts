...
const PLAYGROUND_SAMPLE = {
  name: "Customer Order",
  description:
    "A sample template demonstrating Accord Project features: nested concepts, arrays, joins, monetary amounts, date formatting, and Ergo logic calculations.",
...
export function registerResources(server: McpServer): void {
  ...
  server.resource(
    ...
    {
      description:
        "List available SESAP sample templates with their Concerto model, TemplateMark template, and example data",
  ...
  server.resource(
    ...
    {
      description:
        "Information about SESAP and the contract generation pipeline",
      mimeType: "application/json",
    },
    async (uri) => {
      const info = {
        ...
        description:
          "Transforms meeting transcripts into legally-structured smart contracts using AI and the Accord Project stack.",
        pipeline: [
        ...
        artifactTypes: {
          "model.cto":
            "Concerto data model defining contract variables and types",
          "template.tem.md":
            "TemplateMark template with variable placeholders ({{variableName}})",
